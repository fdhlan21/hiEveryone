...
export default function RegisterScreen({navigaion}) {
  return (
    <View style={styles.container}>
    <ScrollView>
        <View style={styles.container_header}>
            <Text style={styles.welcome_text}>REGISTER ACCOUNT</Text>
        </View>
        ...
        }}>Silahkan Untuk Daftar,{'\n'}
        Agar Kamu Bisa Bisa Masuk dan Terhubung Dengan Lainnya!</Text>
                </View>
        </View>
        ...
        <View style={{
            ...
            <TextInput style={{
                ...
                fontSize:12,
                paddingRight:10, 
                paddingLeft:10}} placeholder='Masukan Username' placeholderTextColor='gray' />
